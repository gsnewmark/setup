...
# install DE + i3 WM
yaourt -S xfce4 notify-osd xfce4-screenshooter gnome-keyring i3-wm python-i3-git i3blocks dmenu2 quickswitch-i3 compton feh ttf-font-awesome skb gvfs xorg-utils xdotool
